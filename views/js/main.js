...
var selectRandomMeat = function() {
  randomMeat = pizzaIngredients.meats[Math.floor((Math.random() * pizzaIngredients.meats.length))];
  return randomMeat;
};

var selectRandomNonMeat = function() {
  randomNonMeat = pizzaIngredients.nonMeats[Math.floor((Math.random() * pizzaIngredients.nonMeats.length))];
  return randomNonMeat;
};

var selectRandomCheese = function() {
  randomCheese = pizzaIngredients.cheeses[Math.floor((Math.random() * pizzaIngredients.cheeses.length))];
  return randomCheese;
};

var selectRandomSauce = function() {
  randomSauce = pizzaIngredients.sauces[Math.floor((Math.random() * pizzaIngredients.sauces.length))];
  return randomSauce;
};

var selectRandomCrust = function() {
  randomCrust = pizzaIngredients.crusts[Math.floor((Math.random() * pizzaIngredients.crusts.length))];
  return randomCrust;
};
...
var pizzaElementGenerator = function(i) {
  ...
  pizzaImageContainer.style.width = '33.33%';
  ...
  pizzaDescriptionContainer.style.width = '33.33%';
...
var resizePizzas = function(size) {
  ...
  const elem = document.getElementById("pizzaSize");
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const movingElem = document.getElementById("movingPizzas1");
